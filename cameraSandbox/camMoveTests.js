    ...
    var zoomDestinationId;
     ...
     function zoomAndDollyToPoint(startPoint,destinationId,callback){
        ...
        var destinationVector = destinationPoint.position.clone(),
...
// ss.CameraMotions.prototype = {
//     constructor: ss.CameraMotions,
...
//             cameraPath = this.cameraPathToPoint(this.camera.position.clone(), point.clone()), // cameraPathToPoint
//             currentPosition = {now: 0},
//             duration = 1.3,
//             upClone = ss.Settings.cameraDefaultUp.clone(),                                // cameraDefualtUp
//             targetCurrent = this.target.clone();                                              // target
//         TweenMax.to(targetCurrent,duration/1.5,{
//             x:pointClone.x,                                                                   //pointClone
//             y:pointClone.y,
//             z:pointClone.z
//         });
//         TweenMax.to(currentPosition,duration,{          
...
//         if (this.camera.up.equals(ss.Settings.cameraDefaultUp) &&
//             this.camera.position.equals(ss.Settings.cameraDefaultPosition) &&
//             this.target.equals(ss.Settings.cameraDefaultTarget)) {
...
//             galaxyLoopToHome : ss.Settings.cameraDefaultPosition.clone().sub(galaxyLoopStart.clone()),
//             targetLoopToHome : ss.Settings.cameraDefaultTarget.clone().sub(targetLoopStart.clone()),
//             upLoopToHome : ss.Settings.cameraDefaultUp.clone().sub(upLoopStart.clone())
//         }
//     },
